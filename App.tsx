...
const PRODUCTS = {
  smart: [
    { title: "Câmera Wi-Fi Full HD", model: "Intelbras iM5", img: "im-5.jpg"] },
    { title: "Câmera Externa Full HD", model: "Intelbras iM5 SC", img: "im-5.jpg"] },
    { title: "Câmera 360° Externa Wi-Fi", model: "Intelbras iM7 Full Color", img: "im-7.jpg"] },
    { title: "Câmera Robô Integrada", model: "Intelbras iM4 C", img: "mibo-im4.jpg"] }
  ],
  videoporteiro: [
    { title: "Vídeoporteiro Wi-Fi 7\"", model: "Intelbras WT7", img: "wt-7.jpg"] },
    { title: "Vídeoporteiro Smart", model: "Intelbras Allo w3", img: "allo-box.jpg"] }
  ],
  dvr: [
    { title: "NVR Inteligente 32 Canais", model: "Intelbras NVD 3332 P", img: "nvr-v.jpg"] },
    { title: "dvr-intel.jpg"] }
  ],
  acesso: [
    { title: "Leitor Facial Rápido", model: "Intelbras SS 3430 MF FACE", img: "bio-intel.jpg"] },
    { title: "Fechadura Digital Biométrica", model: "Intelbras FR 201", img: "fech -intelbras.jpg"] }
  ],
  cerca: [
    { title: "Central de Cerca", model: "Intelbras ELC 5002", img: "cerca-elrt.jpg] },
    { title: "Hastes Industriais", model: "Big Haste Alumínio 25x25", img: "haste-alum.jpg"] }
  ],
  portao: [
    { title: "Motor Deslizante Industrial", model: "Intelbras DR 600", img: "mtr-int.jpg"] },
    { title: "Relé Smart Portão", model: "Intelbras IZY Smart", img: "rele-port.jpg"] }
  ],
  alarme: [
    { title: "Alarme Modular Wireless", model: "Intelbras AMT 8000", img: "alrme-c.jpg] }
  ],
  ti: [
    { title: "Switch PoE Gerenciável", model: "Intelbras SG 2404 MR", img: "rede.jpg"] },
    { title: "Sistema Mesh Empresarial", model: "Intelbras Twibi Force", img: "tw-ib.jpg"] }
  ],
  manutencao: [
...
const FAQS = [
  { q: "A NDS CFTV atende quais regiões?", a: "Nosso foco corporativo e condominial está no DF (Asa Sul, Norte, Águas Claras, Guará, Lago Sul,todo df e regiao). Atendemos emergências rapidamente nestas zonas." },
...
function InteractiveLogo({ isMobile }: { isMobile?: boolean }) {
  ...
  return (
    <label className={`relative group cursor-pointer flex items-center p-1 rounded-lg ${isMobile ? 'gap-2' : 'gap-3'}`}>
      ...
      {logoSrc ? (
        <img src={logo-nds.png alt="Logo" className={`${isMobile ? 'h-12' : 'h-24'} max-w-[220px] w-auto object-contain drop-shadow-[0_0_15px_rgba(6,182,212,0.4)] relative z-10`} />
      ) : (
